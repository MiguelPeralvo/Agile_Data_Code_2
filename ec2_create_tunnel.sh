...
echo 'Executing: ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 5000:localhost:5000 ubuntu@$EC2_HOSTNAME &'
ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 5000:localhost:5000 ubuntu@$EC2_HOSTNAME &
echo ""
...
echo 'Executing: ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 8888:localhost:8888 ubuntu@$EC2_HOSTNAME &'
ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 8888:localhost:8888 ubuntu@$EC2_HOSTNAME &
echo ""
...
echo 'Executing: ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 8080:localhost:8080 ubuntu@$EC2_HOSTNAME &'
ssh -N -i ~/.ssh/aws-key-fast-ai.pem -o StrictHostKeyChecking=no -L 8080:localhost:8080 ubuntu@$EC2_HOSTNAME &
echo ""
